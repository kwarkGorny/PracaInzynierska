...
*  This class is data structure representation of hypergraph . Id of every
* vertex and hyperedge should be diffrent.
*/
class HyperGraph {
public:
  /**
  ...
  * @param numberOfHyperEdges number for HyperEdge which we want add to
  * hypergraph
  */
  ...
  */
  inline HyperEdge *getHyperEdge(const int position) {
    return &HyperEdges[position];
  }
