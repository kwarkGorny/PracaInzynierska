...
class IncidencyMatrix
{
    public:
        ...
        */
        void setConnection (const int positionOfHyperEdge,const int positionOfVertex,const int value);
        ...
        */
        int getConnection (const int positionOfHyperEdge,const int positionOfVertex) const;

        /** @brief Change whole IncidencyMatrix
        *   @param newMatrix value of new Incidency Matrix
        */
        inline void setIncidencyMatrix(const std::vector<std::vector<int>> &newMatrix){incidencyMatrix=newMatrix;}
